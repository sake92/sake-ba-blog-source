...
object ApiFirstScala extends ProgrammingTemplate {

  override def pageSettings =
    super.pageSettings
      .withTitle("API-First Scala")
      .withLabel("API-First Scala")
      .withDescription(
        "API-First Scala"
      )
  ...
  def conclusionSection = Section(
    ...
    frag(
      ...
      Check out the video demo too:
      """.md,
      raw(
        """ <iframe width="100%" src="https://www.youtube.com/embed/kf0vGrlKNb8?si=l9_hclW2cr2Rc9Pd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> """
      ),
      s"""
